...
public class EscapeServer implements Runnable {
      ...
      while (!breakLoop) {
        ...
        while (!ready()) {
          ...
          if (tickCounter % Settings.INTERVAL_REPORT_STATUS == 0) {
            ...
            String message = String.format("%d mobile players connected.", count);
   ...
   *          - the player's name
   */
  public static Player registerPlayer(final Socket clientSocket, final DataOutputStream dOutput,
