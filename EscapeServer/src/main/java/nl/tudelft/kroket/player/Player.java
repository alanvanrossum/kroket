...
public class Player {
   ...
   * @param stream the dataoutputstream to use to reach the client
   * @param name the user's name
   */
  public Player(final Socket socket,final DataOutputStream stream,final String name) {
  ...
  /**
   * Set player socket.
   * @param socket the socket the player is connected to
   */
